...
from .metrics import aggregate_weighted_metrics
...
class XGBoostSimulationStrategy:
    """
    ...
    def __init__(
        ...
        self.save_on_rounds = save_on_rounds
        ...
        self.client_evaluation_history = {}
    ...
    def _wrap_aggregate_fit(self, strategy) -> None:
        ...
        def wrapped_aggregate_fit(server_round, results, failures):
            ...
            self.round_history.append(
            {
                ...
                "global_num_trees": int(
                    self.current_num_trees
                ),
                **metrics,
            }
)
    ...
    def _save_if_needed(self, server_round: int, parameters: Parameters) -> None:
        ...
        should_save = (
            server_round % self.save_on_rounds == 0
